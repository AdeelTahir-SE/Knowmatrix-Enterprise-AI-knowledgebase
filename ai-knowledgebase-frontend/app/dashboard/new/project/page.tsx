        ...
        <div>
          <div className="relative space-y-8 before:absolute before:left-4 before:top-4 before:-bottom-4 before:w-[2px] before:bg-border">
            ...
            <div className="relative flex gap-4">
              <div
                className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-xs font-bold z-10 ring-4 ring-white transition-colors ${step >= 1 ? "bg-primary text-white" : "bg-section-bg text-text-lighter border border-border"}`}
              >
                1
              </div>
              <div className="pt-1.5">
                <h3
                  className={`mb-1.5 text-sm font-bold ${step >= 1 ? "text-text-dark" : "text-text-medium"}`}
                >
                  Project Details
                </h3>
                <p
                  className={`text-sm leading-relaxed ${step >= 1 ? "text-text-light" : "text-text-lighter"}`}
                >
            ...
            <div className="relative flex gap-4">
              <div
                className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-xs font-bold z-10 ring-4 ring-white transition-colors ${step >= 2 ? "bg-primary text-white" : "bg-section-bg text-text-lighter border border-border"}`}
              >
                2
              </div>
              <div className="pt-1.5">
                <h3
                  className={`mb-1.5 text-sm font-bold ${step >= 2 ? "text-text-dark" : "text-text-medium"}`}
                >
                  AI Configuration
                </h3>
                <p
                  className={`text-sm leading-relaxed ${step >= 2 ? "text-text-light" : "text-text-lighter"}`}
                >
            ...
            <div className="relative flex gap-4">
              <div
                className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-xs font-bold z-10 ring-4 ring-white transition-colors ${step >= 3 ? "bg-primary text-white" : "bg-section-bg text-text-lighter border border-border"}`}
              >
                3
              </div>
              <div className="pt-1.5">
                <h3
                  className={`mb-1.5 text-sm font-bold ${step >= 3 ? "text-text-dark" : "text-text-medium"}`}
                >
                  Review
                </h3>
                <p
                  className={`text-sm leading-relaxed ${step >= 3 ? "text-text-light" : "text-text-lighter"}`}
                >
          ...
          <div className="rounded-2xl border border-border bg-white p-6 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.05)] sm:p-10">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="mt-1.5 text-xs text-text-lighter">
                      Give your project a friendly and descriptive name.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <p className="mt-1.5 text-xs text-text-lighter">
                      Describe the purpose or use case of this project.
                    </p>
                  </div>
                </div>
            ...
            {step === 2 && (
              <div className="animate-fade-in-up">
                ...
                <p className="mb-8 text-sm text-text-light">
                  Select the models that will power your project.
                </p>
                ...
                <div className="space-y-6">
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div>
                      ...
                      <p className="mt-1.5 text-xs text-text-lighter">
                        Select the model provider for chat and Q&A.
                      </p>
                    </div>
                  ...
                  <div>
                    ...
                    <p className="mt-1.5 text-xs text-text-lighter">
                      Used to convert your documents into vectors for search.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-1.5 text-xs text-text-lighter">
                      Choose the region where your data will be stored.
                    </p>
                  </div>
                </div>
            ...
            {step === 3 && (
              <div className="animate-fade-in-up">
                ...
                <p className="mb-8 text-sm text-text-light">
                  Verify your project details before creation.
                </p>
                  ...
                  <div className="rounded-xl border border-border bg-section-bg p-5">
                    <div className="flex items-start gap-4 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-text-lighter font-mono">
                          acme.knowmatrix.ai/{slug}
                        </p>
                        {description && (
                ...
                <div className="mt-10 flex items-center justify-between border-t border-border-light pt-6">
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="btn btn-primary px-8 disabled:opacity-70"
                  >
